                               ...
                               void          *recv_data )
{
   ...
   case  1:
   {
	...
	double *d_recv_data = (double *) recv_data;
        nvtxRangePushColor("MPI_Irecv", 0xFF00FFFF);
   	for (i = 0; i < num_recvs; i++)
   	{
        ...
        nvtxRangePop();
        nvtxRangePushColor("MPI_Isend", 0xFF00FFFF);

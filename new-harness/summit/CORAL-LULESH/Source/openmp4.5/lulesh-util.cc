                               ...
                               Int_t numRanks)
{
   ...
   double nxyz = ((double)nx)*nx*nx;
   Real_t grindTime1 = ((elapsed_time*1e6)/locDom.cycle())/nxyz;//   (nx*nx*nx);
   nxyz = nxyz*numRanks;
   Real_t grindTime2 = ((elapsed_time*1e6)/locDom.cycle())/nxyz;//  (nx*nx*nx*numRanks);

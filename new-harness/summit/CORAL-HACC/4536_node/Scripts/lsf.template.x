...
echo jsrun --smpiargs="-mca coll ^ibm" ${JSRUN_OPTIONS} ./h6smt1.sh $EXECUTABLE ./indat ./cmbM000.tf m000 INIT ALL_TO_ALL -w -R -N 512 -t 63x36x72
time jsrun --smpiargs="-mca coll ^ibm" ${JSRUN_OPTIONS} ./h6smt1.sh $EXECUTABLE ./indat ./cmbM000.tf m000 INIT ALL_TO_ALL -w -R -N 512 -t 63x36x72 &
myPid=$!


#-----------------------------------------------------
# If we have been running 15 minutes get the call stack
#-----------------------------------------------------
sleep 900

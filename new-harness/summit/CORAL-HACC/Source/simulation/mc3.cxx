...
double sum_rho_alive(GRID_T * __restrict__ arr) {
  int i, j, k, ca[DIMENSION], ngla[DIMENSION], nglt[DIMENSION], ngo;
  double val=0.0;
...
void fft_copy_arr_forward(GRID_T * __restrict__ arr, COMPLEX_T * __restrict__ fft_arr) {
  int i, j, k;
...
void fft_copy_arr_backward(COMPLEX_T * __restrict__ fft_arr, GRID_T * __restrict__ arr) {
  int i, j, k;
  int ngla[DIMENSION], nglt[DIMENSION], ngo;

...
void SkewerSet::InitializeSlaves(int masterid) {
    ...
    MPI_Comm comm = Partition::getComm();
    MPI_Bcast(&Ntotal, 1, MPI_INT, masterid, comm);
    MPI_Bcast(&Npixels, 1, MPI_INT, masterid, comm);
    MPI_Bcast(&h, 1, MPI_DOUBLE, masterid, comm);
    ...
    MPI_Bcast((double*)geoms, 7*Ntotal, MPI_DOUBLE, masterid, comm);
...
void ParallelSkewerSet::InitializeSlaves(int masterid) {
    ...
    MPI_Comm comm = Partition::getComm();
    MPI_Bcast(&L, 1, MPI_DOUBLE, masterid, comm);
    MPI_Bcast(&Nmesh, 1, MPI_INT, masterid, comm);
...
void ConvergentSkewerSet::InitializeSlaves(int masterid) {
    ...
    MPI_Comm comm = Partition::getComm();
    MPI_Bcast(&L, 1, MPI_DOUBLE, masterid, comm);
    MPI_Bcast(&zbox, 1, MPI_DOUBLE, masterid, comm);
    MPI_Bcast(&Nmesh, 1, MPI_INT, masterid, comm);

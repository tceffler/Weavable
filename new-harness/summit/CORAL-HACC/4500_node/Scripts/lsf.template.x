...
echo jsrun --smpiargs="-mca coll ^ibm" ${JSRUN_OPTIONS} ./h6smt1.sh $EXECUTABLE ./indat ./cmbM000.tf m000 INIT ALL_TO_ALL -w -R -N 512 -t 70x90x30
time jsrun --smpiargs="-mca coll ^ibm" ${JSRUN_OPTIONS} ./h6smt1.sh $EXECUTABLE ./indat ./cmbM000.tf m000 INIT ALL_TO_ALL -w -R -N 512 -t 70x90x30

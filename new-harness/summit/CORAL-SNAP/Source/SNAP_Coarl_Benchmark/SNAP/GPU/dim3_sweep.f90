...
MODULE dim3_sweep_module
  ...
  USE data_module, ONLY: src_opt, qim, ng
...
!!$   call dim3_sweep_cuda(ich,id,oct,g,ichunk,ndimen,noct,&
!!$        nang,nx,ny,nz,jst,kst,cmom,src_opt,ng,&
!!$        jlo,klo,jhi,khi,jd,kd,&
!!$        lasty,lastz,firsty,firstz,&
!!$        d1,d2,d3,d4,&
!!$        vdelt,w,&
!!$        hi,hj,hk,mu,&
!!$        psii,psij,psik,psi,pc,&

...
!_______________________________________________________________________
  ...
  REAL(r_knd) :: tsnap=zero, tparset=zero, tinp=zero, tset=zero,       &
    ...
    tinrconv=zero, inrconv12=zero, inrconv23=zero, inrconv34=zero, inrconv45=zero
...
!_______________________________________________________________________
    ...
    tinrmisc = tinners - ( tinrsrc + tsweeps + tinrconv )
    ...
    WRITE( ounit, 415 ) tinrconv
    WRITE( ounit, 512 ) inrconv12
    WRITE( ounit, 523 ) inrconv23
    WRITE( ounit, 534 ) inrconv34
    WRITE( ounit, 534 ) inrconv45
...
!_______________________________________________________________________
    ...
    415 FORMAT( 10X, 'Inner conv', T41, ES11.4 )
    ...
    512 FORMAT( 10X, 'Inner conv12', T41, ES11.4 )
    523 FORMAT( 10X, 'Inner conv23', T41, ES11.4 )
    534 FORMAT( 10X, 'Inner conv34', T41, ES11.4 )
    545 FORMAT( 10X, 'Inner conv45', T41, ES11.4 )

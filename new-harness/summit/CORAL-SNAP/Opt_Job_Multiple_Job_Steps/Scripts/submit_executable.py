...
def create_a_job_submitter(batch_recursive_mode,
    ...
    #                                                    -
    #-----------------------------------------------------
    my_executable = build_utilities.get_path_to_snap_gpu_executable(path_to_workspace)

    #-----------------------------------------------------
    # Get the dirname of the snap input files.           -
    #                                                    -
    #-----------------------------------------------------
    dirnameinputfiles = build_utilities.get_dirname_of_optjob_snap_inputfiles(path_to_workspace)

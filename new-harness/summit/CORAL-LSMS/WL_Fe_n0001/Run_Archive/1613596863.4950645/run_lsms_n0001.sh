...
#BSUB -q batch
#BSUB -J WL-Fe_n0001
#BSUB -o /autofs/nccs-svm1_proj/csc425/olcf-acceptance-harness/applications/new-harness/summit/CORAL-LSMS/WL_Fe_n0001/Run_Archive/1613596863.4950645/WL-Fe_n0001.o%J
#BSUB -e /autofs/nccs-svm1_proj/csc425/olcf-acceptance-harness/applications/new-harness/summit/CORAL-LSMS/WL_Fe_n0001/Run_Archive/1613596863.4950645/WL-Fe_n0001.e%J
#BSUB -nnodes 1
#BSUB -W 60
#BSUB -P csc425
...
#-----------------------------------------------------
EXECUTABLE="/autofs/nccs-svm1_proj/csc425/olcf-acceptance-harness/Scratch/CORAL-LSMS/WL_Fe_n0001/1613596863.4950645/build_directory/bin/wl-lsms"
...
WORKDIR="/autofs/nccs-svm1_proj/csc425/olcf-acceptance-harness/Scratch/CORAL-LSMS/WL_Fe_n0001/1613596863.4950645/workdir"
RESULTSDIR="/autofs/nccs-svm1_proj/csc425/olcf-acceptance-harness/applications/new-harness/summit/CORAL-LSMS/WL_Fe_n0001/Run_Archive/1613596863.4950645"
UNIQUE_ID_STRING="1613596863.4950645"
INPUT=./i_lsms_16
NUM_LSMS=5
STEPS_PER_WALKER=10
MPI_PER_LSMS=1
...
echo "jsrun --progress ./progress_lsms.${LSB_JOBID}.txt --exit_on_error 1 --nrs $TOTAL_MPI --tasks_per_rs 1 --cpu_per_rs 1 --gpu_per_rs 1 --bind rs $EXECUTABLE $WORKDIR/$INPUT -mode 1d -size_lsms ${NUM_ATOMS} -num_lsms ${NUM_LSMS} -num_steps ${TOTAL_STEPS} -energy_calculation multistep  1> stdout.txt 2> stderr.txt"

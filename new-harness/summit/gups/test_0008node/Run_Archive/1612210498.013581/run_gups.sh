...
#------------------------------------------------------------------------------
#BSUB -J gups
#BSUB -o /autofs/nccs-svm1_proj/csc425/olcf-acceptance-harness/applications/new-harness/summit/gups/test_0008node/Run_Archive/1612210498.013581/gups.o%J
#BSUB -e /autofs/nccs-svm1_proj/csc425/olcf-acceptance-harness/applications/new-harness/summit/gups/test_0008node/Run_Archive/1612210498.013581/gups.e%J
#BSUB -P csc425
#BSUB -W 60
#BSUB -q batch
#BSUB -nnodes 8
...
# Define variables.
#-----------------------------------------------------
STARTING_DIR="/autofs/nccs-svm1_proj/csc425/olcf-acceptance-harness/applications/new-harness/summit/gups/test_0008node/Scripts"
RESULTS_DIR="/autofs/nccs-svm1_proj/csc425/olcf-acceptance-harness/applications/new-harness/summit/gups/test_0008node/Run_Archive/1612210498.013581"
WORK_DIR="/gpfs/alpine/scratch/bzf/csc425/gups/gups/test_0008node/1612210498.013581/workdir"
EXECUTABLE_PATH="gups.summit"
TEST_ID="1612210498.013581"
...
function main
{
 ...
 #CMD="jsrun -p 16 $BUILD_DIR/$EXECUTABLE 1> run-stdout.txt 2> run-stderr.txt"
 echo "$CMD"
 $CMD

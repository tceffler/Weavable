...
#------------------------------------------------------------------------------
#BSUB -J gups
#BSUB -o /autofs/nccs-svm1_proj/csc425/olcf-acceptance-harness/applications/new-harness/summit/gups/test_0001node/Run_Archive/1612207872.8815765/gups.o%J
#BSUB -e /autofs/nccs-svm1_proj/csc425/olcf-acceptance-harness/applications/new-harness/summit/gups/test_0001node/Run_Archive/1612207872.8815765/gups.e%J
#BSUB -P csc425
#BSUB -W 30
#BSUB -q batch
#BSUB -nnodes 1
...
RESULTS_DIR="/autofs/nccs-svm1_proj/csc425/olcf-acceptance-harness/applications/new-harness/summit/gups/test_0001node/Run_Archive/1612207872.8815765"
WORK_DIR="/gpfs/alpine/scratch/bzf/csc425/gups/gups/test_0001node/1612207872.8815765/workdir"
EXECUTABLE_PATH="gups.summit"
TEST_ID="1612207872.8815765"
...
function main
{
 ...
 CMD="jsrun --smpiargs='-disable_gpu_hooks' -g 6 -p 1 -c ALL_CPUS $SOURCE_DIR/bin/$EXECUTABLE_PATH -e 6 -R $RUNTIME"

...
#------------------------------------------------------------------------------
#BSUB -J gups
#BSUB -o /autofs/nccs-svm1_proj/csc425/olcf-acceptance-harness/applications/new-harness/summit/gups/test_0001node/Run_Archive/1611677744.631937/gups.o%J
#BSUB -e /autofs/nccs-svm1_proj/csc425/olcf-acceptance-harness/applications/new-harness/summit/gups/test_0001node/Run_Archive/1611677744.631937/gups.e%J
#BSUB -P __account_id__
#BSUB -W 30
#BSUB -q batch
#BSUB -nnodes 1
#BSUB -env "all"
...
RESULTS_DIR="/autofs/nccs-svm1_proj/csc425/olcf-acceptance-harness/applications/new-harness/summit/gups/test_0001node/Run_Archive/1611677744.631937"
WORK_DIR="/gpfs/alpine/scratch/bzf/csc425/gups/gups/test_0001node/1611677744.631937/workdir"
#WORKSPACE_DIR= $WORK_DIR #"__workspace_dir__"
EXECUTABLE_PATH="gups.summit"
TEST_ID="1611677744.631937"
...
function main
{
 ...
 CMD="jsrun -p 1 -c ALL_CPUS $BUILD_DIR/$EXECUTABLE"

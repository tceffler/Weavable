...
#------------------------------------------------------------------------------
#BSUB -J gups
#BSUB -o /autofs/nccs-svm1_proj/csc425/olcf-acceptance-harness/applications/new-harness/summit/gups/test_0001node/Run_Archive/1611683398.1654327/gups.o%J
#BSUB -e /autofs/nccs-svm1_proj/csc425/olcf-acceptance-harness/applications/new-harness/summit/gups/test_0001node/Run_Archive/1611683398.1654327/gups.e%J
#BSUB -P csc425
#BSUB -W 30
#BSUB -q batch
#BSUB -nnodes 1
...
RESULTS_DIR="/autofs/nccs-svm1_proj/csc425/olcf-acceptance-harness/applications/new-harness/summit/gups/test_0001node/Run_Archive/1611683398.1654327"
WORK_DIR="/gpfs/alpine/scratch/bzf/csc425/gups/gups/test_0001node/1611683398.1654327/workdir"
EXECUTABLE_PATH="gups.summit"
TEST_ID="1611683398.1654327"
...
function main
{
 ...
 CMD="jsrun -g 6 -p 1 -c ALL_CPUS $SOURCE_DIR/bin/$EXECUTABLE_PATH"
